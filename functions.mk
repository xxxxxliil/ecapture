...
define gobuild
	...
	$(CMD_GO) build -tags '$(TARGET_TAG),netgo' -ldflags "-w -X 'github.com/gojue/ecapture/cli/cmd.GitVersion=$(TARGET_TAG)_$(GOARCH):$(VERSION_NUM):$(VERSION_FLAG)' -linkmode=external -extldflags -static " -o $(OUT_BIN)
	$(CMD_FILE) $(OUT_BIN)
endef
